...
public class Coup {
    ...
    Coup(Point dP, Point aP, Point aC, boolean aCaisse){
        departPousseur = dP;
        arriveePousseur = aP;
    ...
    public String toString() {
        return aCaisse + " " + departPousseur.x + "," + departPousseur.y + " => " + arriveePousseur.x + "," + arriveePousseur.y;
    }
}
